...
`/transaction_create` - создание транзакции *(Примечание: category_id может быть 0, т.е. у транзакции нет категории. Положительное значение amount => доход, отрицательное => расход. У доходов не должно быть категории ("default", или 0))*
